...
3. PRs will be considered complete when the rest of the team (2 remaining people excluding individual who created teh PR) reviews and approves the merge of the PR.
4. Disagreements can be resolved by a vote between the team, where the majority in the group vote will come to the agreement.
